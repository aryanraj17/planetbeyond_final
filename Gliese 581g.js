...
const loader = new GLTFLoader().setPath('temp/gliese_581_g/');
loader.load('scene.gltf', (gltf) => {
  ...
  moonMesh.position.set(0, 0, -10);  // Center it in front of the camera
  moonMesh.scale.set(0.001, 0.001, 0.001);  // Keep the moon size large
  scene.add(moonMesh);
